            ...
            <div class="col-md-12 col-lg-7 col-xl-7">
                <div class="card shadow-lg o-hidden border-0 my-5">
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="p-5"><img class="login-logo" src="{{URL::to('assets/img/mock-logo.png')}}">
                                    <form class="user" action="/dashboard/post-login/" method="POST">
                                        ...
                                        </div><button class="btn btn-primary d-block btn-user w-100 ui-btn" type="submit">Login</button>
                                    ...
                                    <div class="text-center"><a class="small" href="/dashboard/register">Create an Account!</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
